...
<style lang="scss">
	...
	.modal-container{
		...
		.modal-content{
			width: 65%;border-radius: 10rpx;background: #fff;overflow: hidden;animation: fadeZoom .15s linear;
			.modal-title{
				padding: 20rpx 20rpx 0;text-align: center;color: #404040;font-size: $fontSizeLg;
			}
			...
			.modal-row{
				display: flex;text-align: center;font-size: $fontSizeLg;line-height: 80rpx;position: relative;color: #404040;
				.modal-col{
