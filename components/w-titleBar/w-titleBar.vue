	...
	<view>
		<view style="width: 100%;z-index: 999999;" :style="{background:bgColor,position:fixed=='none'?'none':'fixed'}">
			...
			<view class="titlebarbar " :style="{color:textColor}">
				<image :src="returnColor == 0?'../../static/w-titleBar/avators.png':'../../static/w-titleBar/avators.png'"
				 v-if="isReturn" @tap="open"></image>
				<view style="line-height: 44px;width: 100%;margin-left: 24rpx;color:#222222;" :class="[textAlign == 'left'?'textLeft':'textCenter']"
